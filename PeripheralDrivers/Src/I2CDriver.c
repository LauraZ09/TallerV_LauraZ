...
/*7.a. Activamos la indicación para no-ACK(indicación para el Slave del terminal)*/
void i2c_sendNoAck(I2C_Handler_t *ptrHandlerI2C){
	/*Debemos escribir 0 en la posición ACK del registro de control 1*/
	ptrHandlerI2C->ptrI2Cx->CR1 &= ~I2C_CR1_ACK;
}

/* 7b. Activamos la indicación para no-ACK (indicación para el slave de terminal)*/
void i2c_sendAck(I2C_Handler_t *ptrHandlerI2C){
	/*(Debemos escribir cero en la posición ACK del registror de control 1)*/
	ptrHandlerI2C->ptrI2Cx->CR1 |= I2C_CR1_ACK;
}
...
void i2c_sendMemoryAddress(I2C_Handler_t *ptrHandlerI2C, uint8_t memAddr){
	/*4. Enviamos la direcciín de memoria que deseamos leer*/
...
uint8_t i2c_readDataByte(I2C_Handler_t *ptrHandlerI2C){
	/*9. Esperamos que el byte sea recibido */
...
uint8_t i2c_readSingleRegister(I2C_Handler_t *ptrHandlerI2C, uint8_t regToRead){
	...
	/* 6. Generamos la condición NoAck, para que el Master no responda y el slace solo envíe 1 byte*/
...
void i2c_writeSingleRegister(I2C_Handler_t *ptrHandlerI2C, uint8_t regToRead, uint8_t newValue){
	...
	/*4. Enviamos el bvalor que deseamos escribir en el registro deseado*/
